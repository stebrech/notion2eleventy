import filteredRequest from "./filteredRequest.js";

async function createArray({ dbId, dsId, postType, requiredMetadata, optionalMetadata, permalink }) {
	try {
		const filteredData = await filteredRequest({ dbId, dsId, postType, requiredMetadata });
